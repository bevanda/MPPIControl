...
## Build Info:
## 
## Final product: ./Sample_MPPI_CartPole.a
...
PRODUCT_NAME              = Sample_MPPI_CartPole
MAKEFILE                  = Sample_MPPI_CartPole_rtw.mk
COMPUTER                  = GLNXA64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home_net/pbevanda/MPPIControl/matlab_implementation/codegen/lib/Sample_MPPI_CartPole
ARCH                      = glnxa64
TGT_FCN_LIB               = ISO_C++
...
PRODUCT = ./Sample_MPPI_CartPole.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/home_net/pbevanda/MPPIControl/matlab_implementation -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=Sample_MPPI_CartPole -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
%.o : /home_net/pbevanda/MPPIControl/matlab_implementation/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /home_net/pbevanda/MPPIControl/matlab_implementation/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
